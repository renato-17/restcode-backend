Feature: RegistrarDueñoDeRestaurante
  ...
  Scenario:  El dueño de restaurante crea su cuenta
    ...
    When ingresa sus datos personales y de su  restaurante
      | UserName | FirstName | LastName | Cellphone | Email             | Password        | Ruc         | Name          |  Address    | PhoneNumber   |
      | cintia12 | Cintia    | Rosales  | 912334411 | cintiar@gmail.com | Rosalescintia#1 | 12745621351 | El mero Loco  | Chorrillos  | 456789123     |
